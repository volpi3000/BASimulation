...
public class Simulation
{
	...
	{
		// links und rechts nach parkpl�tzen schauen und parken , wenn auto im richtigen
		// modus#
		...
		if (car.getState() == status.SEARCHING)
		{
			int x = 0;
			int y = 0;
			// Wenn in eing�ngen geparkt werden soll muss das hier eingef�gt werden
